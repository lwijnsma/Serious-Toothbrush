...
INSERT INTO ALBUM(TITLE,ARTIST,YEAR,CREATED_AT, UPDATED_AT)
VALUES('MORE VANVAR','VANVAR','2007','2017-10-19','2017-10-19');


INSERT INTO ALBUM(TITLE,ARTIST,YEAR,CREATED_AT, UPDATED_AT)
VALUES(' EVEN MORE VANVAR','VANVAR','2007','2017-10-19','2017-10-19');


INSERT INTO ALBUM(TITLE,ARTIST,YEAR,CREATED_AT, UPDATED_AT)
VALUES('SLIGHTLY TO MUCH VANVAR','VANVAR','2007','2017-10-19','2017-10-19');


INSERT INTO ALBUM(TITLE,ARTIST,YEAR,CREATED_AT, UPDATED_AT)
VALUES('DEFINITLY TO MUCH VANVAR','VANVAR','2007','2017-10-19','2017-10-19');
...
INSERT INTO SONGS(TITLE, ARTIEST,LENGTH,CREATED_AT,UPDATED_AT,ALBUM_ID,GENRE_ID,QUALITY_ID,PRICE,description,file_location)
VALUES('Blimp','<a href="https://soundcloud.com/vanvarmusic">VANVAR</a>','1:25.5','2017-10-19','2017-10-19','1','1','1',7.12,'wow','songs/Blimp.mp3');

INSERT INTO SONGS(TITLE, ARTIEST,LENGTH,CREATED_AT,UPDATED_AT,ALBUM_ID,GENRE_ID,QUALITY_ID,PRICE,description,file_location)
VALUES('The Tiger','<a href="https://soundcloud.com/vanvarmusic">VANVAR</a>','1:25.5','2017-10-19','2017-10-19','2','2','2',17.12,'wow','songs/The-Tiger.mp3');

INSERT INTO SONGS(TITLE, ARTIEST,LENGTH,CREATED_AT,UPDATED_AT,ALBUM_ID,GENRE_ID,QUALITY_ID,PRICE,description,file_location)
VALUES('My Game','<a href="https://soundcloud.com/vanvarmusic">VANVAR</a>','1:25.5','2017-10-19','2017-10-19','2','2','2',17.12,'wow','songs/My-Game.mp3');

INSERT INTO SONGS(TITLE, ARTIEST,LENGTH,CREATED_AT,UPDATED_AT,ALBUM_ID,GENRE_ID,QUALITY_ID,PRICE,description,file_location)
VALUES('Dreaming','<a href="https://soundcloud.com/vanvarmusic">VANVAR</a>','1:25.5','2017-10-19','2017-10-19','1','3','4',17.12,'wow','songs/Dreaming.mp3');

INSERT INTO SONGS(TITLE, ARTIEST,LENGTH,CREATED_AT,UPDATED_AT,ALBUM_ID,GENRE_ID,QUALITY_ID,PRICE,description,file_location)
VALUES('Dance to it','<a href="https://soundcloud.com/vanvarmusic">VANVAR</a>','1:25.5','2017-10-19','2017-10-19','2','1','1',17.12,'wow','songs/Dance-to-it.mp3');

INSERT INTO SONGS(TITLE, ARTIEST,LENGTH,CREATED_AT,UPDATED_AT,ALBUM_ID,GENRE_ID,QUALITY_ID,PRICE,description,file_location)
VALUES('Its You','<a href="https://soundcloud.com/vanvarmusic">VANVAR</a>','1:25.5','2017-10-19','2017-10-19','2','3','1',17.12,'wow','songs/Its-You.mp3');
...
INSERT INTO CART_SONGS(SONGS_ID,CART_ID)
VALUES('1', 1);
...
INSERT INTO LIBRARY_SONGS(SONGS_ID,LIBRARIES_TITLE,LIBRARIES_USERS_ID)
VALUES('2','MAIN LIBRARY',1);

INSERT INTO LIBRARY_SONGS(SONGS_ID,LIBRARIES_TITLE,LIBRARIES_USERS_ID)
VALUES('3','MAIN LIBRARY',1);

INSERT INTO LIBRARY_SONGS(SONGS_ID,LIBRARIES_TITLE,LIBRARIES_USERS_ID)
VALUES('1','MAIN LIBRARY',3);

INSERT INTO LIBRARY_SONGS(SONGS_ID,LIBRARIES_TITLE,LIBRARIES_USERS_ID)
VALUES('5','MAIN LIBRARY',5);

INSERT INTO LIBRARY_SONGS(SONGS_ID,LIBRARIES_TITLE,LIBRARIES_USERS_ID)
VALUES('4','MAIN LIBRARY',1);
