<div class="col">
      ...
      <div class="card-body">
        <?php include 'include/admin/admin_add_albums.php'; ?>
         <form class="" role="form" action="<?php ($_SERVER['PHP_SELF']);?>" method="post">
            <div class="row">
                  <label for="">Album Title:</label><input type="text" class="form-control" name="title"  value="" size="20" >
            </div>
            <div class="row">
   ...
   rows="10" cols="50">
               ...
               <div class="row">
                   <button class="btn btn-success" type="submit" name="album_add" value="album_add">Add</buttton>
                  </div>
            </form>
      </div>
   </div>
